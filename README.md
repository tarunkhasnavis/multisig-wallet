...
_ [Submit Transaction](#submit-transaction)
_ [Add Transaction](#add-transaction)
_ [Confirm Transaction](#confirm-transaction) \* [Execute Transaction](#execute-transaction)
<!--te-->
...
The **_indexed_** keyword in the event declaration makes the event easily searchable and is useful when building user interfaces that need to parse lots of events.
